...
module top (
	...
	logic [15:0]	sub_A, sub_B, sub_diff;
	logic 		sub_OF;
	...
	assign sub_A[15:0] = A[16] ? B[15:0] : A[15:0];	//A and B should be flipped on subtractor when A is negative
	assign sub_B[15:0] = A[16] ? A[15:0] : B[15:0];

	assign S[16] = (A_lt_B & B[16]) | (~A_lt_B & A[16]) | (A[16] & B[16]);
