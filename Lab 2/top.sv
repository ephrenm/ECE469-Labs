// This module is the CLA with addition and differnece function

module CLA_Arithetic_Module(
	...
	// B must be inverted for 2's complement to work
	logic [15:0] B_inverted;
	assign B_inverted = ~B;
